...
FW_DRIVERS="DRM_I915 DRM_AMDGPU DRM_XE DRM_NOUVEAU IWLWIFI IWLMVM BRCMFMAC MWIFIEX MWIFIEX_PCIE BT_HCIBTUSB BT_INTEL BT_BCM ATH11K ATH11K_PCI ATH12K ATH12K_PCI MT76_CORE RTW89_CORE RTW89_PCI SND_SOC_SOF_PCI SND_SOC_SOF_ALDERLAKE SND_SOC_SOF_RAPTORLAKE SND_SOC_SOF_COMETLAKE SND_SOC_SOF_CANNONLAKE SND_SOC_SOF_TIGERLAKE SND_SOC_SOF_ROCKETLAKE SND_SOC_SOF_ICELAKE SND_SOC_SOF_JASPERLAKE SND_SOC_SOF_ELKHARTLAKE SND_SOC_SOF_KABYLAKE SND_SOC_SOF_SKYLAKE SND_SOC_SOF_METEORLAKE SND_SOC_SOF_LUNARLAKE SND_HDA_INTEL"
