...
$SC --disable CPU_FREQ_DEFAULT_GOV_POWERSAVE
$SC --disable CPU_FREQ_DEFAULT_GOV_USERSPACE
$SC --disable CPU_FREQ_DEFAULT_GOV_SCHEDUTIL
$SC --disable CPU_FREQ_DEFAULT_GOV_ONDEMAND
