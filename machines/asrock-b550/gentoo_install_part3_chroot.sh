...
# No intel-microcode — AMD microcode is in linux-firmware
...
# EFI fallback path — some UEFI implementations only boot from EFI/Boot/bootx64.efi
...
# Standard DPI — desktop with normal monitors
...
# NVIDIA modprobe config — desktop (no Optimus/PRIME)
...
# ASRock B550: 64GB RAM, 8GB zram swap
load_on_start="no"
unload_on_stop="no"
num_devices="1"
type0="swap"
